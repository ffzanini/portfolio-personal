                  ...
                  {category.technologies.map((tech, techIndex) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-linear-to-br from-white/5 to-transparent rounded-xl opacity-0 group-hover/tech:opacity-100 transition-opacity duration-300" />
                      </div>
                    </div>
                  ))}
                </div>
