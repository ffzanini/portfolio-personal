...
export function HomeContent({ home, locale }: Readonly<HomeContentProps>) {
  return (
    <div
      data-home-scroll-lock
      className="flex min-h-screen flex-col bg-linear-to-br from-primary-200 via-white-theme to-white-theme lg:h-dvh lg:max-h-dvh lg:overflow-hidden dark:bg-linear-to-br dark:from-primary-950 from-15% dark:via-dark-theme via-30% dark:to-dark-theme to-100%"
    >
        ...
        <div className="grid w-full grid-cols-1 items-center gap-6 lg:max-h-full lg:grid-cols-2 lg:gap-8">
          <div className="order-2 space-y-4 sm:space-y-6 lg:order-1 xl:space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs sm:gap-4 sm:text-sm">
              <div className="flex items-center gap-1.5">
                <LuMapPin className="h-4 w-4 shrink-0 text-primary-600" />
                <span className="text-sm">{home.location}</span>
              </div>
              <div className="flex items-center gap-1.5">
                <LuCalendar className="h-4 w-4 shrink-0 text-primary-600" />
                <span className="text-sm">{home.experience}</span>
              </div>
              <div className="flex items-center gap-1.5">
                <LuCoffee className="h-4 w-4 shrink-0 text-primary-600" />
            ...
            <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:gap-4">
              <Link
                ...
                className="group flex flex-row items-center justify-center rounded-lg bg-linear-to-r from-primary-400 to-primary-600 px-6 py-2.5 font-semibold text-white shadow-lg shadow-primary-600/25 transition-transform duration-300 hover:from-primary-500 hover:to-primary-700 hover:shadow-xl sm:px-8 sm:py-3"
              >
              ...
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex flex-row items-center justify-center rounded-lg border-2 border-gray-300 px-6 py-2.5 font-semibold text-gray-700 backdrop-blur-sm transition-colors duration-300 hover:bg-gray-100 sm:px-8 sm:py-3 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800/50"
              >
          ...
          <div className="order-1 mt-8 flex justify-center lg:order-2 lg:mt-0 lg:justify-end">
            <div className="relative p-8 sm:p-10">
              <div
                className="absolute top-0 left-0 z-20 animate-float-up rounded-lg border border-gray-200/50 bg-white/95 p-3 shadow-xl sm:p-4 dark:border-gray-700/50 dark:bg-black/70"
              ...
              <div
                className="absolute right-0 bottom-0 z-20 animate-float-down rounded-lg border border-gray-200/50 bg-white/95 p-3 shadow-xl sm:p-4 dark:border-gray-700/50 dark:bg-black/70"
                style={{ willChange: "transform" }}
              >
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <LuCodeXml className="h-4 w-4 text-primary-600 sm:h-5 sm:w-5" />
              ...
              <div className="relative z-0 rounded-2xl border border-gray-200/50 bg-white/90 p-4 shadow-2xl sm:p-6 lg:p-8 dark:border-gray-700/50 dark:bg-black/60">
                <div className="relative mx-auto mb-4 aspect-square h-32 w-32 sm:mb-6 sm:h-40 sm:w-40 lg:h-50 lg:w-50">
                  <div className="absolute inset-0 rounded-xl bg-linear-to-br from-primary-400 via-primary-600 to-primary-800 opacity-80" />
                ...
                <div className="space-y-3 text-center sm:space-y-4">
                  ...
                  <Link
                    ...
                    className="inline-block font-semibold text-gray-600 underline underline-offset-4 hover:text-black dark:text-gray-300 dark:hover:text-white"
                  >
