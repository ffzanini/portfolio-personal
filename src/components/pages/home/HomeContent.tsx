  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-primary-200 via-white-theme to-white-theme dark:bg-linear-to-br dark:from-primary-950 from-15% dark:via-dark-theme via-30% dark:to-dark-theme to-100%">
      <div className="relative flex flex-col h-screen">
        <main className="flex flex-col justify-center items-center lg:h-screen z-10 max-w-7xl mx-auto w-full pb-8 flex-1">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center mx-auto px-3">
            ...
            >
              <div className="relative">
                <div
                  className="absolute -top-4 sm:-top-8 -left-4 sm:-left-8 bg-white/95 dark:bg-black/70 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-2xl p-3 sm:p-4 shadow-xl z-10 animate-float-up"
                  style={{ willChange: "transform" }}
                >
                ...
                <div
                  className="absolute -bottom-6 -right-6 bg-white/95 dark:bg-black/70 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-2xl p-3 sm:p-4 shadow-xl z-10 animate-float-down"
                  style={{ willChange: "transform" }}
                >
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <LuCodeXml className="h-4 w-4 sm:h-5 sm:w-5 text-primary-600" />
